...
public static class CellFunctions
{
    ...
    public static CellType_e[] cellUpdateOrder = { CellType_e.GENERATOR, CellType_e.CWROTATER, CellType_e.CCWROTATER, CellType_e.FLIPPER, CellType_e.MOVER, CellType_e.PULLER};
